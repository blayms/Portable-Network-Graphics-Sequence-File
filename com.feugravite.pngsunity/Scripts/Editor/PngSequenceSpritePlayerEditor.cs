...
namespace Blayms.PNGS.Unity.Editor
{
    ...
    public class PngSequenceSpritePlayerEditor : InspectorEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            playerInstance.clip = (PngSequenceSpriteFileUnity)EditorGUILayout.ObjectField("Clip", playerInstance.clip, typeof(PngSequenceSpriteFileUnity), true);
            ...
            playerInstance.target = (SpriteRenderer)EditorGUILayout.ObjectField("Sprite Renderer", playerInstance.target, typeof(SpriteRenderer), true);
